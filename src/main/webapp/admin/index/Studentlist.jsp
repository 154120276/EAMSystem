    ...
    <div>
        <nav>
            <ul class="pagination">
                ...
                <c:if test="${pb.pageNum != 1}">
                    <li>
                    <a href="${pageContext.request.contextPath}/students?pageNum=${pb.pageNum-1}&rows=5" aria-label="Previous">
                </c:if>
               ...
               <c:forEach begin="1" end="${pb.pages}" var="i">
                   <c:if test="${pb.pageNum ==i}">
                       <li class="active"><a href="${pageContext.request.contextPath}/students?pageNum=${i}&rows=5">${i}</a></li>
                   </c:if>
                   <c:if test="${pb.pageNum !=i}">
